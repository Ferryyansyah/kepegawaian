    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1 class="lead">
          Tambah / Ubah Master Lokasi Kerja
          </h1>
          <hr>
          <ol class="breadcrumb">
  ...
  <div class="content"> 
    <table style="width:55%">
      <tr>
        <td>Kode Cabang</td>
        <td>
        <form action="inputlok" method="post">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">  
          <div class="input-control text full-size">
            <input style="width:40%;" type="text" name="kode">
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="input-control text full-size">
            <input style="width:100%;" type="text" name="nama_cabang">
          </div>
        </td>
      </tr>
      </table>
