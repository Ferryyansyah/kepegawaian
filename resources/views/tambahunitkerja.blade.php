    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Tambah / Ubah Master Skkpd / Unit Devisi
          </h1>
        </section>
        <!-- Main content -->
  ...
  <div class="content"> 
    <table style="width:55%">
      <tr>
        <td>Kode Divisi</td>
        <td>
        <form action="inputuni" method="post">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="input-control text full-size">
            <input style="width:50%;" type="text" name="kode_divisi">
          </div>
          <br>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="input-control text full-size">
            <input style="width:100%;" type="text" name="nama_divisi">
          </div>
          <br>
        </td>
      </tr>
