      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Lokasi Kerja</li>
          </ol>
        </section> 
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header" style="background:#0072C6">
                  <h3 style="color:white;" class="box-title">List Lokasi Kerja</h3>
                  <a href="/tambahlokasikerja"><button style="float:right;border:none;background:#82BA00;height:30px;width:150px;color:white" type="submit">Tambah Data</button></a>
                </div><!-- /.box-header -->
                <div class="box-body" style="background:#fff">
                  <table id="example2" class="table table-bordered table-hover" style="background:#ECF0F5">
                    ...
                    @foreach($lokasikerja as $lokasikerja)
                      <tr>
                        <td>{{ $lokasikerja->id_cabang }}</td>
                        <td>{{ $lokasikerja->nama }}</td>
                        <td><div class="btn-group">
                          <a class="btn btn-default" href="{{ url('edlokasi/'.$lokasikerja->id) }}">
                          <i class="fa fa-arrow-right"></i>
                         </a>
                         <div class="btn-group">
                           <a class="btn btn-default" onclick="return confirm('Yakin Hapus?')" href="{{ url('lokasikerja/delete/'.$lokasikerja->id) }}">
