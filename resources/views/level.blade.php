            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header" style="background:#0072C6">
                  <h3 style="color:white;" class="box-title">List level</h3>
                  <a href="/tambahlevel"><button style="float:right;border:none;background:#82BA00;height:30px;width:150px;color:white" type="submit">Tambah Data</button></a>
                </div><!-- /.box-header -->
                    ...
                    @foreach($level as $level)
                      <tr>
                        ...
                        <td><div class="btn-group">
                          <a class="btn btn-default" href="{{ url('edlevel/'.$level->id) }}">
                          <i class="fa fa-arrow-right"></i>
                         </a>
                         <div class="btn-group">
                           <a class="btn btn-default" onclick="return confirm('Yakin Hapus?')" href="{{ url('level/delete/'.$level->id) }}">
