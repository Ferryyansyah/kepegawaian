          ...
          <div class="row">
            <div class="col-lg-4 col-xs-6">
              ...
              <div class="small-box bg-custom-1">
                ...
                <a href="/profilpegawai" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-4 col-xs-6">
              <!-- small box -->
            ...
            </div><!-- ./col --><div class="col-lg-4 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-custom-1">
                <div class="inner">
                  <h3>{{ $lokasikerja }}</h3>
                  <p>Jumlah Lokasi Kerja</p>
                </div>
                <div class="icon">
                  <i class="ion "></i>
                </div>
                <a href="/lokasikerja" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-4 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-custom-1">
                ...
                <a href="/unitkerja" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-4 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-custom-1">
                ...
                <a href="/level" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-4 col-xs-6">
              <!-- small box -->
