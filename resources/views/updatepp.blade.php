...
<html>
  <head>
    ...
    <!-- Ionicons -->
    <link restylesheet" href="{{url('https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
    <!-- Theme style -->
    ...
    <table style="width:55%">
      <tr>
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
          ...
          <input style="width:60%;" type="text" name="nik" value="{{ $profilpegawai->nik }}">
          </a>
          </div>
          </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="input-control text full-size">
            <input style="width:100%;" type="text" name="nama" value="{{ $profilpegawai->nama }}">
          </div>
        </td>
      </tr>
       <tr>
      <td>Tanggal Lahir</td>
      <td>
      <input class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" type="text" name="tanggal_lahir" value="{{ $profilpegawai->tanggal_lahir }}">         
      </td>
      </tr>
       <tr>
        <td>Level</td>
        <td>
          ...
          <select style="width:100%" name="level" value="{{ $profilpegawai->level}}"> 
      ...
      <tr>
        ...
        <td>
          <div class="input-control select">
          <select style="width:100%" name="lokasi_kerja" value="{{ $profilpegawai->lokasi_kerja  }}">>
      ...
      <tr>
        ...
        <td>
          <div class="input-control select">
          <select style="width:100%" name="unit_kerja" value="{{ $profilpegawai->unit_kerja }}">>
      ...
      <tr>
        ...
        <td>
          <div class="input-control select">
          <select style="width:100%" name="jabatan" value="{{ $profilpegawai->jabatan }}">>
      ...
      <tr>
        ...
        <td>
          ...
          <select style="width:40%;" name="status_aktif" value="{{ $profilpegawai->status_aktif }}">>
      ...
      <tr>
        ...
        <td>
          <div class="input-contol text full-size">
          <select style="width:40% ;" name="status_kawin" value="{{ $profilpegawai->status_kawin }}">>
      ...
      <tr>
        ...
        <td>
          <div class="input-control text full-size">
            <input style="width:100%;" type="text" name="nomor_sk" value="{{ $profilpegawai->nomor_sk }}">>
          </div>
        </td>
      </tr>
      <tr>
      <td>Tanggal Sk</td>
      <td>
      <input class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" type="text" name="tanggal_sk" value="{{ $profilpegawai->tanggal_sk }}">>          
      </td>
      </tr>
      </tr>
      <tr>
     ...
     <tr>
        ...
        <td>
          <div class="input-control text full-size">
            <textarea style="width:100%" name="alamat" value="{{ $profilpegawai->alamat }}">></textarea>
          </div>
        </td>
      </tr>
      <tr>
      <tr>
        ...
        <td>
          <div class="input-control text full-size">
            <input style="width:50%;" type="text" name="rt_rw" value="{{ $profilpegawai->rt_rw }}">>
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="input-contol text full-size">
          <input type="text" style="width:100%" name="kode_pos" value="{{ $profilpegawai->kode_pos }}">>
          </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="input-contol text full-size">
          <input type="text" style="width:100%" name="tlp" value="{{ $profilpegawai->tlp }}">
          </div>
        </td>
      </tr>
      </table>
