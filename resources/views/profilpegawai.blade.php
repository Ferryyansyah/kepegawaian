...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="{{url('stylesheet" href="/bootstrap/css/bootstrap.min.css')}}">
    <!-- Font Awesome -->
    <link rel="{{url('stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css')}}">
    <!-- Ionicons -->
    <link rel="{{ur('stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
    <!-- Theme style -->
    <link rel="{{url('stylesheet" href="/dist/css/AdminLTE.min.css')}}">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="{{url('stylesheet" href="/dist/css/skins/_all-skins.min.css')}}">
    <!-- iCheck -->
    <link rel="{{url('stylesheet" href="/plugins/iCheck/flat/blue.css')}}">
    <!-- Morris chart -->
    <link rel="{{url('stylesheet" href="/plugins/morris/morris.css')}}">
    <!-- jvectormap -->
    <link rel="{{url('stylesheet" href="/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}">
    <!-- Date Picker -->
    <link rel="{{url('stylesheet" href="/plugins/datepicker/datepicker3.css')}}">
    <!-- Daterange picker -->
    <link rel="{{url('stylesheet" href="/plugins/daterangepicker/daterangepicker-bs3.css')}}">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="{{url('stylesheet" href="/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- Slimscroll -->
    <script src="{{url('plugins/slimScroll/jquery{{url('.slimscroll.min.js')}}"></script>
    <!-- FastClick -->
